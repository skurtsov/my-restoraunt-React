...
import Visitor_fr from './Components/Visitor_fr/Visitor_fr';
...
function App(props) {
  return (
    <div className="App">
      ...
      <Route path="/fr" element={<Visitor_fr plus ={props.plus} minus={props.minus} plus_loc ={props.plus_loc} minus_loc={props.minus_loc} newOrderLoc={props.newOrderLoc} newOrder={props.newOrder} orders_loc={props.orders_loc} orders={props.orders} state={props.state}/>}></Route>
